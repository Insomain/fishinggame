...
public class Planet extends GameObject
{
    ...
    {
        return point.distanceTo(getPosition()) < _radius;
    }
    ...
    public Vector2 getRandomPoint()
    {
        ...
        return new Vector2(radius, theta).toCartesian().add(getPosition());
    }

    public void draw(GreenfootImage canvas, Camera camera)
    {
        Vector2 drawPosition = camera.getScreenPosition(getPosition());
